...
class MaterialsManagement {
    ...
    static deleteMaterial(materialId) {
        if (confirm('Are you sure you want to delete this material?')) {
            fetch(`/api/teacher/materials/${materialId}/delete/`, {
                method: 'POST',
                headers: {
                    'X-CSRFToken': document.querySelector('[name=csrfmiddlewaretoken]').value
                }
...
class ClassManagement {
    ...
    static viewClassDetails(classId) {
        ...
        fetch(`/api/teacher/classes/${classId}/details/`, {
            headers: {
                'X-CSRFToken': document.querySelector('[name=csrfmiddlewaretoken]').value
            }
        })
    ...
    static handleAnnouncement() {
        ...
        fetch('/api/teacher/announcements/send/', {
            method: 'POST',
            headers: {
                'X-CSRFToken': document.querySelector('[name=csrfmiddlewaretoken]').value
            },
...
console.log('Teacher Management Handlers loaded successfully!');
